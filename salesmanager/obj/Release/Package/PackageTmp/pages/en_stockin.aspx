<%@ Page Title="" Language="C#" MasterPageFile="~/sales.Master" AutoEventWireup="true" CodeBehind="en_stockin.aspx.cs" Inherits="salesmanager.pages.en_stockin" %>
                                                ...
                                                <asp:DataGrid ID="dgproductInfo" runat="server" AllowPaging="false" AutoGenerateColumns="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="Quantity" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtqty" runat="server" Width="90%" AutoPostBack="true" OnTextChanged="txtqty_OnTextChanged">
                                                                </asp:TextBox>
                                                            </ItemTemplate>
