<%@ Page Title="" Language="C#" MasterPageFile="~/sales.Master" AutoEventWireup="true" CodeBehind="info_assignjob.aspx.cs" Inherits="salesmanager.pages.info_assignjob" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>Assign Job</b>
                            <asp:LinkButton ID="btnaddnew" runat="server" Text="Add New" CssClass="btn btn-default" PostBackUrl="~/pages/en_assignjob.aspx"></asp:LinkButton>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <asp:DataGrid ID="dgassignjobInfo" runat="server" AllowPaging="True" PageSize="15" AutoGenerateColumns="false"
                                                Width="100%" BorderStyle="None" CellPadding="0" GridLines="None" AllowSorting="True"
                                                CssClass="table table-bordered table-striped" OnItemCommand="dgassignjobInfo_ItemCommand"
                                                OnPageIndexChanged="dgassignjobInfo_PageIndexChanged">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                                        <ItemTemplate>
                                                            <a href="en_assignjob.aspx?cId=<%# Eval("assignjobId") %>" title="Edit" class="btn btn-primary btn-xs">Edit</a>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="imgDelete" runat="server" CausesValidation="false" CommandName="delete" AlternateText="Delete"
                                                                ...
                                                                CommandArgument='<%# Eval("assignjobId") %>' />
                                                        </ItemTemplate>
                                                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" Width="10%" />
                                                    </asp:TemplateColumn>
                                                </Columns>
