<%@ Page Title="" Language="C#" MasterPageFile="~/sales.Master" AutoEventWireup="true" CodeBehind="info_usertype.aspx.cs" Inherits="salesmanager.pages.info_usertype" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>User Type</b>
                            <asp:LinkButton ID="btnaddnew" runat="server" Text="Add New" CssClass="btn btn-default" PostBackUrl="~/pages/en_usertype.aspx"></asp:LinkButton>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <asp:DataGrid ID="dgusertypeInfo" runat="server" AllowPaging="True" PageSize="15" AutoGenerateColumns="false"
                                    Width="100%" BorderStyle="None" CellPadding="0" GridLines="None" AllowSorting="True"
                                    CssClass="table table-bordered table-striped" OnItemCommand="dgusertypeInfo_ItemCommand"
                                    OnPageIndexChanged="dgusertypeInfo_PageIndexChanged">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="usertype Name" Visible="true">
                                            <ItemTemplate>
                                                <%# Eval("usertypename")%>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                                            <ItemTemplate>
                                                <a href="en_usertype.aspx?uId=<%# Eval("usertypeId") %>" title="Edit" class="btn btn-primary btn-xs">Edit</a>
                                            </ItemTemplate>
