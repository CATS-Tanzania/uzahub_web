<%@ Page Title="" Language="C#" MasterPageFile="~/sales.Master" AutoEventWireup="true" CodeBehind="en_userprofile.aspx.cs" Inherits="salesmanager.pages.en_userprofile" %>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlusertype" runat="server" CssClass="form-control" Enabled="false"></asp:DropDownList>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Button ID="btncancel" runat="server" Text="Cancel" CssClass="btn btn-default" CausesValidation="false" Visible="false" OnClick="btncancel_Click" />
